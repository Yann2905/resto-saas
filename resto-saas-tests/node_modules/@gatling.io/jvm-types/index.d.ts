...
interface Binary$TypedConditionStatic {
    readonly class: any;
    new (arg0: any): io.gatling.javaapi.http.Binary$TypedCondition;
}
export declare const Binary$TypedCondition: Binary$TypedConditionStatic;
interface Binary$UntypedConditionStatic {
    readonly class: any;
    new (arg0: any): io.gatling.javaapi.http.Binary$UntypedCondition;
}
export declare const Binary$UntypedCondition: Binary$UntypedConditionStatic;
...
export declare const ConnectActionBuilder: ConnectActionBuilderStatic;
...
export declare const Cookie: CookieStatic;
interface CoreDslStatic {
    ...
    css(arg0: Func<io.gatling.javaapi.core.Session, string>): any;
    ...
    dummy(arg0: Func<io.gatling.javaapi.core.Session, string>, arg1: Func<io.gatling.javaapi.core.Session, int | null>): io.gatling.javaapi.core.DummyBuilder;
    ...
    csv(arg0: string, arg1: any): io.gatling.javaapi.core.FeederBuilder$FileBased<string>;
    separatedValues(arg0: string, arg1: any): io.gatling.javaapi.core.FeederBuilder$FileBased<string>;
    separatedValues(arg0: string, arg1: any, arg2: any): io.gatling.javaapi.core.FeederBuilder$FileBased<string>;
    ssv(arg0: string): io.gatling.javaapi.core.FeederBuilder$FileBased<string>;
    ssv(arg0: string, arg1: any): io.gatling.javaapi.core.FeederBuilder$FileBased<string>;
    tsv(arg0: string): io.gatling.javaapi.core.FeederBuilder$FileBased<string>;
    tsv(arg0: string, arg1: any): io.gatling.javaapi.core.FeederBuilder$FileBased<string>;
...
interface DummyBuilderStatic {
    readonly class: any;
    new (arg0: any, arg1: any): io.gatling.javaapi.core.DummyBuilder;
}
export declare const DummyBuilder: DummyBuilderStatic;
...
interface HttpDslStatic {
    ...
    httpConcurrentRequests(arg0: io.gatling.javaapi.http.HttpRequestActionBuilder, ...arg1: io.gatling.javaapi.http.HttpRequestActionBuilder[]): io.gatling.javaapi.core.ActionBuilder;
    httpConcurrentRequests(arg0: java.util.List<io.gatling.javaapi.http.HttpRequestActionBuilder>): io.gatling.javaapi.core.ActionBuilder;
...
export declare const MqttBuilder: MqttBuilderStatic;
interface MqttDslStatic {
    readonly class: any;
    LastWill(arg0: string, arg1: io.gatling.javaapi.core.Body): io.gatling.javaapi.mqtt.LastWillBuilder;
    LastWill(arg0: Func<io.gatling.javaapi.core.Session, string>, arg1: io.gatling.javaapi.core.Body): io.gatling.javaapi.mqtt.LastWillBuilder;
...
export declare const MqttDsl: MqttDslStatic;
interface MqttFixedHeaderStatic {
    readonly class: any;
    new (arg0: io.netty.handler.codec.mqtt.MqttMessageType, arg1: boolean, arg2: io.netty.handler.codec.mqtt.MqttQoS, arg3: boolean, arg4: int): io.netty.handler.codec.mqtt.MqttFixedHeader;
}
export declare const MqttFixedHeader: MqttFixedHeaderStatic;
interface MqttInboundMessageStatic {
    readonly class: any;
    new (timestamp: long, fixedHeader: io.netty.handler.codec.mqtt.MqttFixedHeader, variableHeader: io.netty.handler.codec.mqtt.MqttPublishVariableHeader, payload: bytearray): io.gatling.mqtt.action.MqttInboundMessage;
    of(timestamp: long, message: any): io.gatling.mqtt.action.MqttInboundMessage;
}
export declare const MqttInboundMessage: MqttInboundMessageStatic;
...
export declare const MqttMessageType: MqttMessageTypeStatic;
interface MqttPropertiesStatic {
    readonly class: any;
    new (): io.netty.handler.codec.mqtt.MqttProperties;
}
export declare const MqttProperties: MqttPropertiesStatic;
interface MqttProtocolBuilderStatic {
    readonly class: any;
}
export declare const MqttProtocolBuilder: MqttProtocolBuilderStatic;
interface MqttPublishVariableHeaderStatic {
    readonly class: any;
    new (arg0: string, arg1: int): io.netty.handler.codec.mqtt.MqttPublishVariableHeader;
    new (arg0: string, arg1: int, arg2: io.netty.handler.codec.mqtt.MqttProperties): io.netty.handler.codec.mqtt.MqttPublishVariableHeader;
}
export declare const MqttPublishVariableHeader: MqttPublishVariableHeaderStatic;
...
export declare const MqttQoS: MqttQoSStatic;
interface MqttStatic {
    readonly class: any;
}
export declare const Mqtt: MqttStatic;
...
export declare const PublishActionBuilder$Base: PublishActionBuilder$BaseStatic;
interface PublishActionBuilder$CheckableStatic {
    readonly class: any;
}
export declare const PublishActionBuilder$Checkable: PublishActionBuilder$CheckableStatic;
interface PublishActionBuilderStatic {
    readonly class: any;
    new (arg0: any): io.gatling.javaapi.mqtt.PublishActionBuilder;
}
export declare const PublishActionBuilder: PublishActionBuilderStatic;
...
export declare const RequestActionBuilder: RequestActionBuilderStatic;
...
interface RequestStatic {
    readonly class: any;
    new (arg0: string, arg1: any, arg2: any, arg3: io.netty.handler.codec.http.HttpHeaders, arg4: java.util.List<io.netty.handler.codec.http.cookie.Cookie>, arg5: io.gatling.http.client.body.RequestBody, arg6: long, arg7: boolean, arg8: any, arg9: any, arg10: any, arg11: string, arg12: string, arg13: Func<io.gatling.http.client.Request, io.gatling.http.client.Request>, arg14: any, arg15: boolean, arg16: any, arg17: string): io.gatling.http.client.Request;
}
export declare const Request: RequestStatic;
interface RequestWithBodyActionBuilderStatic {
    readonly class: any;
}
export declare const RequestWithBodyActionBuilder: RequestWithBodyActionBuilderStatic;
...
export declare const Sse$Prefix: Sse$PrefixStatic;
interface SseAwaitActionBuilder$OnStatic {
    readonly class: any;
    new <T>(arg0: io.gatling.javaapi.http.SseAwaitActionBuilder<T, any>, arg1: any): io.gatling.javaapi.http.SseAwaitActionBuilder$On<T>;
}
export declare const SseAwaitActionBuilder$On: SseAwaitActionBuilder$OnStatic;
...
interface SseMessageCheck$TypedConditionStatic {
    readonly class: any;
    new (arg0: any): io.gatling.javaapi.http.SseMessageCheck$TypedCondition;
}
export declare const SseMessageCheck$TypedCondition: SseMessageCheck$TypedConditionStatic;
interface SseMessageCheck$UntypedConditionStatic {
    readonly class: any;
    new (arg0: any): io.gatling.javaapi.http.SseMessageCheck$UntypedCondition;
}
export declare const SseMessageCheck$UntypedCondition: SseMessageCheck$UntypedConditionStatic;
...
export declare const SubscribeActionBuilder$Checkable: SubscribeActionBuilder$CheckableStatic;
interface SubscribeActionBuilderStatic {
    readonly class: any;
}
export declare const SubscribeActionBuilder: SubscribeActionBuilderStatic;
...
interface Text$TypedConditionStatic {
    readonly class: any;
    new (arg0: any): io.gatling.javaapi.http.Text$TypedCondition;
}
export declare const Text$TypedCondition: Text$TypedConditionStatic;
interface Text$UntypedConditionStatic {
    readonly class: any;
    new (arg0: any): io.gatling.javaapi.http.Text$UntypedCondition;
}
export declare const Text$UntypedCondition: Text$UntypedConditionStatic;
...
export declare const WaitForMessagesActionBuilder: WaitForMessagesActionBuilderStatic;
...
export declare const Ws$Prefix: Ws$PrefixStatic;
interface WsAwaitActionBuilder$OnStatic {
    readonly class: any;
    new <T>(arg0: io.gatling.javaapi.http.WsAwaitActionBuilder<T, any>, arg1: any): io.gatling.javaapi.http.WsAwaitActionBuilder$On<T>;
}
export declare const WsAwaitActionBuilder$On: WsAwaitActionBuilder$OnStatic;
...
export declare const WsConnectActionBuilder: WsConnectActionBuilderStatic;
interface WsFrameCheck$BinaryStatic {
    readonly class: any;
    new (arg0: any): io.gatling.javaapi.http.WsFrameCheck$Binary;
}
export declare const WsFrameCheck$Binary: WsFrameCheck$BinaryStatic;
interface WsFrameCheck$TextStatic {
    readonly class: any;
    new (arg0: any): io.gatling.javaapi.http.WsFrameCheck$Text;
}
export declare const WsFrameCheck$Text: WsFrameCheck$TextStatic;
